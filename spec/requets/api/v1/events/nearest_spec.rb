...
describe 'GET /v1/events/nearests?lat=&lon=&radius=', type: :request do
  it 'returns the events closest to the lat and lon' do
    near_event = create(:event, lat: 37.760322, lon: -122.429667)
    farther_event = create(:event, lat: 37.76031, lon: -122.429667)
    create(:event, lat: 37.687737, lon: -122.47608)
    lat = 37.771098
    lon = -122.430782
    radius = 5
